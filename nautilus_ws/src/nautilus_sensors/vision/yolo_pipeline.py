...
class YoloNode(Node):
    def __init__(self, args):
        ...
        if self.mode == 'sim':
            self.model = YOLO(
                '/home/nautilus/NautilusSW/nautilus_ws/src/nautilus_sensors/vision/yolo_models/sim_320_24avril.pt')
        else:
            self.model = YOLO(
                '/home/nautilus/NautilusSW/nautilus_ws/src/nautilus_sensors/vision/yolo_models/competition_18mars.pt')

...
class YoloNode(Node):
    def __init__(self, args):
        ...
        if args.sim:
            self.mode = 'sim'
            self.model = YOLO(
                '/home/devs/NautilusSW/nautilus_ws/src/nautilus_sensors/vision/yolo_models/bbox_sim_640.pt')
        else:
            self.mode = 'real'
            self.model = YOLO('/home/devs/NautilusSW/nautilus_ws/src/nautilus_sensors/vision/yolo_models/model_prequal.pt')

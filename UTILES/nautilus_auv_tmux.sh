...
tmux send-keys -t "$SESSION:bringup.1" "ros2 run nautilus_sensors stream_threaded" C-m
...
tmux send-keys -t "$SESSION:mission.2" "ros2 run nautilus_mission master_node --auv"
